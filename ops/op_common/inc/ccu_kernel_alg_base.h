...
// Host-side CalGoSize for batched kernels built on CcuKernelAlgBase.
// parallelDim here MUST equal the value passed to AllocGoResource; drift
// between the two leaves the tail slice of each payload unemitted.
